								...
								foreach ($payment_gateways as $gateway) {
									...
									<div class="radio col-xs-3 paymode_div">
										<input type="radio" name="pay_mode" class="pay_mode"
											...
											src="/assets/images/<?php echo $gateway->image ?>"
	...
	<div class="wizard-content">
		...
		<div class="form">
			<form id="create-admin-form">
				...
				<input type="text" class="required-input" placeholder="User name" id="admin_username" name="username"
					   value="" required="required"/>
			    <label>Name</label>
				<input type="text" class="required-input" placeholder="Complete name" id="admin_name" name="name"
					   value="" required="required"/>
