...
<link href="{{ URL::asset('sass/styles.css') }}" rel="stylesheet">
    ...
    <div class="contact-container">
        <div class="prescription-inner container alert-danger" style="min-height: 680px;text-align:center;line-height:60px;">
             <h2><strong>{{ __('Failure')}} !</strong> {{ __('Your payment was not processed')}}.</h2>
             <p> {{ __('Due to some technical issues')}}, {{ __('your payment was not processed')}}, {{ __('please contact us incase of any queries')}}.</p>
             <a href="{{url('/')}}" class="btn btn-warning" style="background-color: #6d7289">{{ _('Back To Home')}}</a>
        </div>
        <!-- prescription-cont -->
    </div>
    <footer>
