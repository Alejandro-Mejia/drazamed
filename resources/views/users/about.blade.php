@include('...header')
    ...
    <div class="contact-container">
        <div class="contact-inner container">
            <div class="col-sm-3">
                <h1 class="contact-h1">{{ __('About')}} {{ Setting::param('site','app_name')['value'] }}</h1>
            </div>
            <div class="col-sm-9 contact-right-section about-cont">
                <div class="contact-right-upper">
                    ...
                    <ul class="contact-ul">
                        ...
                        <li>{{ __('Our pharmacists will identify, examine and update your prescription in the very next moment')}}.
</li>
                        <li>{{ __('Verify and make the payment') }}, {{ __('you will be notified regarding status of the shipment')}}.</li>
                    </ul>

                    <p>{{ __('We made it simple and trouble free for you to connect with us for making yourpurchase of medicine online')}}.</p>
